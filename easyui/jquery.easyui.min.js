...
(function ($) {
    ...
    function _297(_298) {
        ...
        var win = $(_298).panel($.extend({}, _299.options, {
            border: false, hasResized: false, doSize: true, closed: true, cls: "window " + (!opts.border ? "window-thinborder window-noborder " : (opts.border == "thin" ? "window-thinborder " : "")) + (opts.cls || ""), headerCls: "window-header " + (opts.headerCls || ""), bodyCls: "window-body " + (opts.noheader ? "window-body-noheader " : " ") + (opts.bodyCls || ""), onBeforeDestroy: function () {
...
(function ($) {
    function _2df(_2e0) {
        ...
        $(_2e0).dialog($.extend({}, opts, {
            cls: "drawer f-column window-shadow layout-panel layout-collapsed layout-panel-" + opts.region, bodyCls: "f-full", collapsed: false, top: 0, left: "auto", right: "auto", onResize: function (w, h) {
                if (opts.collapsed) {
...
(function ($) {
    ...
    $.fn.swiper.defaults = {
        width: "auto", height: 200, selected: 0, duration: 400, interval: 2000, autoplay: false, indicator: true, onChange: function (_308) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.timeline.defaults = {
        width: "auto", height: "auto", data: [], dotStyler: function (row) {
            return "";
...
(function ($) {
    ...
    function _33c(_33d, pp, _33e) {
        ...
        pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body", halign: opts.halign }, _33e, {
            onBeforeExpand: function () {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, halign: "top", onSelect: function (_36a, _36b) {
...
(function ($) {
    ...
    function _3a4(_3a5, _3a6, pp) {
        ...
        pp.panel($.extend({}, _3a6, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_3a6.icon ? _3a6.icon : undefined), onLoad: function () {
                if (_3a6.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 32, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3f1) {
...
(function ($) {
    ...
    function _410(_411, _412, el) {
        ...
        var _414 = $.extend({}, $.fn.layout.paneldefaults, {
        ...
        _418.resizable($.extend({}, {
            handles: (_417[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _400 = true;
    ...
    function _42d(_42e, _42f, _430) {
        ...
        function _435(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", titleDirection: _433.titleDirection, iconCls: (_433.hideCollapsedContent ? null : _433.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _433.region, collapsedSize: _433.collapsedSize, noheader: (!isns && _433.hideExpandTool), tools: ((isns && _433.hideExpandTool) ? null : [{
    ...
    $.fn.layout.defaults = {
        fit: false, onExpand: function (_463) {
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapseDelay: 100, collapsedSize: 32, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_468) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 150, itemHeight: 32, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _483, mouseleave: _486, mouseover: _48a, mouseout: _48d, click: _48f }, position: function (_4ca, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    function _4d4(_4d5, _4d6, data) {
        ...
        $(_4d6).tooltip({
            content: $("<div></div>"), position: opts.floatMenuPosition, valign: "top", data: data, onUpdate: function (_4d7) {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 30, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_540) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiobutton.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_566) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkbox.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_58c) {
        }
    };
})(jQuery);
(function ($) {
    ...
    function _58e(_58f) {
        ...
        for (var i = 0; i < opts.data.length; i++) {
            ...
            rb.radiobutton($.extend({}, { labelWidth: opts.labelWidth, labelPosition: opts.labelPosition, labelAlign: opts.labelAlign }, opts.data[i], {
                checked: opts.data[i].value == opts.value, item: opts.data[i], onChange: function () {
    ...
    $.fn.radiogroup.defaults = {
        dir: "h", name: null, value: null, labelWidth: "", labelPosition: "after", labelAlign: "left", itemStyle: { height: 30 }, onChange: function (_59c) {
        }
    };
})(jQuery);
(function ($) {
    ...
    function _59e(_59f) {
        ...
        for (var i = 0; i < opts.data.length; i++) {
            ...
            ck.checkbox($.extend({}, { labelWidth: opts.labelWidth, labelPosition: opts.labelPosition, labelAlign: opts.labelAlign }, opts.data[i], {
                checked: $.inArray(opts.data[i].value, opts.value) >= 0, item: opts.data[i], onChange: function () {
                    var vv = [];
    ...
    $.fn.checkgroup.defaults = {
        dir: "h", name: null, value: [], labelWidth: "", labelPosition: "after", labelAlign: "left", itemStyle: { height: 30 }, onChange: function (_5b0) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, interval: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, deltaY: 0, novalidate: false, editable: true, disabled: false, readonly: false, validateOnCreate: true, validateOnBlur: false, events: {
            focus: _5b8, blur: _5bc, mouseenter: _5bf, mouseleave: _5c2, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _5f6(_612) {
        ...
        _613.validatebox($.extend({}, opts, {
            deltaX: function (_614) {
    ...
    $.fn.textbox.defaults = $.extend({}, $.fn.validatebox.defaults, {
        doSize: true, autoSize: false, width: "auto", height: "auto", cls: null, prompt: "", value: "", type: "text", multiline: false, icons: [], iconCls: null, iconAlign: "right", iconWidth: 26, buttonText: "", buttonIcon: null, buttonAlign: "right", label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", inputEvents: {
            blur: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: {
            focus: _65f, blur: _663, keydown: function (e) {
...
(function ($) {
    ...
    function load(_6cf, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _6d0, dataType: "json", success: function (data) {
                    _6d1(data);
                }, error: function () {
...
(function ($) {
    function _73b(_73c) {
        ...
        $(_73c).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _73e, doSize: false, onResize: function (_740, _741) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    $.fn.rate.defaults = {
        value: 0, max: 5, size: 24, half: false, readonly: false, disabled: false, starSvg: "<svg focusable=\"false\" viewBox=\"0 0 24 24\"><path d=\"M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z\"></path></svg>", color: "#ececec", selectedColor: "#ffca3e", onChange: function (_7a1, _7a2) {
        }
    };
})(jQuery);
(function ($) {
    ...
    function _7ec(_7ed) {
        ...
        _7ef.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_7f0, _7f1) {
        ...
        if (opts.pagination) {
            ...
            _7f5.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_7f6, _7f7) {
    ...
    function _806(_807) {
        ...
        _80c.each(function () {
            $(this).resizable({
                handles: _80d, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _808.resizing = true;
    ...
    var _94f = $.extend({}, _941(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_950, _951) {
    ...
    var _998 = {
        render: function (_999, _99a, _99b) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", resizeEdge: 5, autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 31, headerEvents: { mouseover: _810(true), mouseout: _810(false), click: _814, dblclick: _819, contextmenu: _81c }, rowEvents: { mouseover: _81e(true), mouseout: _81e(false), click: _825, dblclick: _82f, contextmenu: _833 }, rowStyler: function (_9df, _9e0) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _9e1, dataType: "json", success: function (data) {
                    _9e2(data);
                }, error: function () {
            ...
            getTr: function (_9e4, _9e5, type, _9e6) {
                type = type || "body";
                _9e6 = _9e6 || 0;
...
(function ($) {
    ...
    function _a1b(_a1c) {
        ...
        $(_a1c).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_a1e, row) {
    ...
    var _a2a = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_a2b, _a2c, _a2d) {
            var _a2e = [];
    ...
    $.extend(_a2a, {
        refreshGroupTitle: function (_a60, _a61) {
...
(function ($) {
    function _a81(_a82) {
        ...
        if (opts.pagination) {
            ...
            _a8e.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_a8f, _a90) {
    ...
    var _b2e = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_b2f, _b30, _b31) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _b2e, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _a9c(true), mouseout: _a9c(false), click: _a9e }), loader: function (_b6c, _b6d, _b6e) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _b6c, dataType: "json", success: function (data) {
                    _b6d(data);
                }, error: function () {
            ...
            getTr: function (_b70, id, type, _b71) {
                type = type || "body";
                _b71 = _b71 || 0;
...
(function ($) {
    function _b7a(_b7b) {
        ...
        $(_b7b).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_b7c, row, _b7d) {
                    return opts.textFormatter ? opts.textFormatter(_b7c, row, _b7d) : _b7c;
                }
            }]]
        }));
    };
    var _b7e = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_b7f, _b80, _b81) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _b7e, textFormatter: function (_b9a, row) {
            return _b9a;
...
(function ($) {
    ...
    function _b9d(_b9e) {
        ...
        $(_b9e).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _ba4, onChange: function () {
            }
        }));
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _baf, keydown: _bb3, paste: _bb3, drop: _bb3, blur: _bb6 }, panelEvents: {
...
(function ($) {
    ...
    var _c39 = 0;
    var _c3a = {
        render: function (_c3b, _c3c, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_c40) {
            return _c40;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _c3a, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            mouseover: _c1e, mouseout: _c1f, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _c20, scroll: _c23
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _c44, dataType: "json", success: function (data) {
                    _c45(data);
                }, error: function () {
...
(function ($) {
    function _c7f(_c80) {
        ...
        var grid = _c81.grid;
        $(_c80).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
...
(function ($) {
    function _cc4(_cc5) {
        ...
        $(_cc5).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
        ...
        _cc6.grid.treegrid($.extend({}, opts, {
...
(function ($) {
    function _cf0(_cf1) {
        ...
        $(_cf1).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_cf3, _cf4) {
                _cf5();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_d22) {
...
(function ($) {
    function _d29(_d2a) {
        ...
        $(_d2a).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _d2c(this);
                _d2d(this);
                _d2e(this);
        ...
        if (!_d2b.calendar) {
            ...
            $.extend(_d2b.calendar.calendar("options"), {
...
(function ($) {
    function _d54(_d55) {
        ...
        $(_d55).datebox("calendar").calendar({
            onSelect: function (date) {
...
(function ($) {
    function _d77(_d78) {
        ...
        $(_d78).addClass("timepicker-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _d7a(this);
                _d7b(_d78);
...
(function ($) {
    ...
    function _dc3(_dc4) {
        ...
        _dc6.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_dec) {
            return _dec;
        }, converter: {
            toPosition: function (_ded, size) {
                var opts = $(this).slider("options");
